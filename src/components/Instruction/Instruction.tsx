  ...
  return (
    <article className={styles.instruction}>
      ...
      <ul className={styles.list}>
        ...
        <li className={styles.item}>Сделайте короткий перервы (3-5 минут)</li>
        <li className={styles.item}>Продолжайте работать "помидор" за "помидором", пока задача не будет выполнена. Каждые 4 "помидора" делайте длинный перерыв (15-30 минут)</li>
      </ul>
    </article>
